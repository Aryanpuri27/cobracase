          ...
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap">
                ...
                <span className="font-semibold">one-one-one</span>
              ...
              <ul className="mt-8 space-y-2 text-left font-medium flex flex-col items-center sm:items-start">
                <div className="space-y-2">
                  ...
                  <li className="flex gap-1.5 item-center text-left">
                    <Check className="h-5 w-5 shrink-0 text-green-600" />
                    Morden Iphone models suported.
                  </li>
                </div>
              </ul>
              <div className="mt-12 flex flex-col sm:flex-row item-center sm:items-start gap-5">
        ...
        px-8 sm:px-16 md-px-0 mt-32 lg:mx-0 lg:mt-20 h-fit"
          >
            <div className="relative md:max-w-xl">
              ...
              />
              <Phone className="w-64" imgSrc="\testimonials\1.jpg" />
            </div>
          </div>
        </MaxWidthWrapper>
      </section>
      {/* value proposion section */}
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          <div className="flex flex-col lg:fex-row items-center gap-4 sm:gap-6">
            <h2
              className="order-1 mt-2 tracking-tight text-center
             text-balance !landing-tight font-bold
            ...
            <img src="/snake-2.png" className="w-24 order-0 1g:order-2" />
          </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  design. Hd the case for two and half months now and{" "}
                  <span className="p-0.5 bg-slate-800 text-white">
                    the image is super clear
                  </span>
                  , on the case I had before, the image started fading into
                  yellow-ish color after a couplr weeks.Love it."
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <CheckIcon className="h-4 w-4 strock-[3px] text-green-600 " />
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  and that let to some pretty heavy scratchmarks an all of my
